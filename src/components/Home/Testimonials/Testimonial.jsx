...
const TestimonialCard = ({ testimonial, reviews, loading }) => {
    return (
        <div className="testimonial-card p-5">
            <div className="personl_details justify-center">
                <img
            ...
            <div className="flex-1">
                ...
                <p className="testimonial mt-5 mb-5 ">
                    {testimonial.testimonial}
                </p>
                <div className="flex items-center gap-1 pt-2">
                    {[1, 2, 3, 4, 5]
                        .slice(0, testimonial.review_count)
                        .map((index) => (
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="18"
                ...
                <div className="name_start_box text-left mt-5">
