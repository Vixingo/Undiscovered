    ...
    <div>
      ...
      <Modal centered show={show} size="md" onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>
            {isAuthenticated ? (
              <h2 className="modal_title_h2">College Coach Login Required</h2>
            ) : (
          ...
          <div className="modal_main_div">
            {isAuthenticated ? (
              <p className="">
                ...
                <span onClick={() => navigate("/login")}> Log in</span> to
                access the complete player profile
              </p>
            ) : (
              <p className="">
                Please
                    ...
                    {playerData?.flaggedBy?.find(
                      ...
                      <span className="svg_icone_">
                        <svg
                          ...
                          fill="none"
                          xmlns="http://www.w3.org/2000/svg">
                          <rect width="24" height="24" rx="12" fill="#FF3333" />
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                  ...
                  <div className="flex items-center gap-2 justify-center lg:justify-start">
                    <div className="w-[18px] h-[18px] rounded-full overflow-hidden">
                      <img
                        ...
                        src={school_icon || playerData?.player?.institute?.logo}
                        alt=""
                      />
                    </div>
                              ...
                              <div className="space-y-2 contact_info_text">
                                ...
                                <p className="text-[18px]text-[#000] leading-6 EMAIL_teg">
                                  ...
                                  <div className="email_btn">
                                    <button
                                      onClick={() =>
                                        copyToClipboard(playerData?.auth?.email)
                                      }
                                      className="">
                                      <svg
                                        width="24"
                                    ...
                                    <button
                                      onClick={() =>
                                        openMailClient(playerData?.auth?.email)
                                      }
                                      className="">
                                      <svg
                                        width="24"
                          ...
                          <div className="contact_info_btn_main_div">
                            ...
                            <div className="Phone_div_main_box">
                              <a
                                ...
                                <p>{playerData?.auth?.phoneNumber}</p>
                              </a>
                            </div>
                          </div>
                          <div className="content space-y-4">
                      ...
                      <Collapse isOpened={isCollapsed[3]}>
                        <div>
                          <div className="content space-y-4">
                            ...
                            <ul>
                              <li>
                                Main Port High School(2021-2022)
                                <ul>
                                ...
                                <>
                                  <div className="space-y-2 contact_info_text">
                                    ...
                                    <a className="text-[18px] text-[#4C8FE1] leading-6 hover:underline">
                                      {playerData?.player?.previousCoachName}
                                    </a>
                                  </div>
                                  <div className="space-y-2 contact_info_text">
                                    <p className="text-[18px] text-[#888] leading-normal font-500">
