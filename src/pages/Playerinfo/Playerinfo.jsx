        ...
        <div className="Switch_btn_div_main">
          <div className="Switch_btn_div_sub">
            <div
              ...
              style={{
                borderBottom: switchsection === 0 ? "2px solid #fff" : null,
              }}>
              <button onClick={() => setswithchsetion(0)}>Player</button>
            </div>

            <div
              className="player_btn"
              style={{
                borderBottom: switchsection === 1 ? "2px solid #fff" : null,
              }}>
              <button onClick={() => setswithchsetion(1)}>Coach</button>
            </div>
          </div>
          <div className="signup_btn_div">
            <button onClick={() => navigate("/sign-up")}>Sign Up Today</button>
          </div>
        </div>
